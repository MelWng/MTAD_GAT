...
class Predictor:
    ...
    def predict_anomalies(self, train, test, true_anomalies, load_scores=False, save_output=True,
        ...
        if save_output:
            ...
            print("train_pred_df : ",train_pred_df)
            print("test_pred_df : ",test_pred_df)
            print("test_preds_global : ", test_preds_global )
            train_pred_df_true_only = train_pred_df[train_pred_df["A_Pred_Global"] == 1]
            print(train_pred_df_true_only["A_Pred_Global"].count())
